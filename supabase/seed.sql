...
-- Note: Users should be created through Supabase Auth API in production

-- Create test user (this will be created through API in the app)
-- For now, we'll create the profile data assuming the user exists
