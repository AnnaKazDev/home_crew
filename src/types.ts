...
export type ProfileDTO = Pick<
  ProfileRow,
  'id' | 'name' | 'avatar_url' | 'total_points'
>
...
export interface CreateHouseholdDTO
  extends Pick<HouseholdRow, 'id' | 'name'> {
...
export interface MemberDTO
  extends Pick<MemberRow, 'id' | 'role' | 'joined_at'> {
  user_id: UUID
...
export type UpdateDailyChoreCmd = Partial<
  Pick<DailyChoreRow, 'status' | 'assignee_id'>
>
...
export type PointsEventDTO = Pick<
  PointsRow,
  'id' | 'points' | 'event_type' | 'created_at' | 'daily_chore_id'
>
