...
const HouseholdInfo: React.FC<HouseholdInfoProps> = memo(
  ({ household, currentUserRole, onUpdate, isUpdating = false, className = '' }) => {
            ...
            <div className="mt-2">
              {isEditingName && currentUserRole === 'admin' && onUpdate ? (
                ...
                <div className="flex items-center justify-between">
                  <p className="text-xl font-bold dark:text-white dark:text-blue-100">
                    {household.name}
                  </p>
...
HouseholdInfo.displayName = 'HouseholdInfo';
