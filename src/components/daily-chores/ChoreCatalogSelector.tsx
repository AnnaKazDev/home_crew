  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-muted-foreground">Select from existing chores or define a new one for your household catalog</p>
      </div>
              ...
              <div className="flex-1">
                <h4 className="font-medium text-foreground text-sm group-hover:text-black">
                  ...
                  {item.time_of_day !== 'any' && (
                    <span className="text-xs text-gray-500 ml-1 group-hover:text-black">({getTimeOfDayText(item.time_of_day)})</span>
                  )}
